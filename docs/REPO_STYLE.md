...
* When renaming or moving files, use `git mv` instead of `git rm` plus a re-add.
* This preserves file history and makes diffs easier to review.
* Use `git rm` ONLY when you intend to permanently remove a file from the repo.
